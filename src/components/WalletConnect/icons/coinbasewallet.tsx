...
const CoinbaseWalletIcon = forwardRef<
  SVGSVGElement,
  SvgProps
>(({ className, ...rest }, ref) => {
  return (
    <>
      <svg ref={ref} {...rest} aria-hidden="true" className={className ? className : "h-4"} viewBox="0 0 292 292" fill="none" xmlns="http://www.w3.org/2000/svg">
